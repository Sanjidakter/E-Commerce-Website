...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            if($request->hasFile('slider_image')){
                $requestData['slider_image']=$this->uploadImage
                (request()->file('slider_image'));
            }
            Slider::create($requestData);
             
            return redirect()->route('sliders.index')->withMessage('Slider is added successfully');
        }
    ...
    public function update(Request $request, Slider $slider)
    {
        try{
            ...
            return redirect()->route('sliders.index')->withMessage('Slider is updated successfully');
        }
        catch(QueryException $e){
            return redirect()->back()->withInput()->withErrors($e->getMessage());
        }
